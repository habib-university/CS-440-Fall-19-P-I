...
/**
 * Interpolates a point X in the range PQ to the range AB
 * @param {vecx} P  Start point of original range 
 * @param {vecx} Q  End point of original range
 * @param {vecx} X  Point within first range
 * @param {vecy} A  Start point of new range
 * @param {vecy} B  End point of new range
 * @return {vecy}   X mapped onto range AB
 */
function map_point(P, Q, X, A, B)
{
    var alpha = length(subtract(P, X)) / length(subtract(P, Q));
